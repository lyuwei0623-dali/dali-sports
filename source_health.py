...
def check_sources(odds_key, football_key, football_data_key, day):
    ...
    jobs = [
        ...
        ("API-Football 聯賽強度", "https://v3.football.api-sports.io/status", {"key":football_key,"needs_key":True,"headers":{"x-apisports-key":football_key}}),
        ("football-data.org 近期賽果", "https://api.football-data.org/v4/competitions/PL/standings", {"key":football_data_key,"needs_key":True,"headers":{"X-Auth-Token":football_data_key}}),
    ]
